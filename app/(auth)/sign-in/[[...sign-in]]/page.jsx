        ...
        <div className="w-full max-w-md space-y-6 lg:space-y-8">
          ...
          <div className="bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 lg:p-8 border border-purple-500/30 shadow-2xl shadow-purple-500/20">
            <div className="text-center mb-6 lg:mb-8">
              ...
              <p className="text-gray-400 mt-2 text-sm lg:text-base">Sign in to continue your interview practice</p>
            </div>
            ...
            <SignIn 
              appearance={{
                ...
                elements: {
                  ...
                  socialButtonsBlockButton: 
                    'bg-grey-700 border border-gray-500 text-white hover:bg-gray-600 hover:border-gray-400 transition-all duration-300 rounded-xl py-3.5 px-4 font-medium shadow-lg hover:shadow-xl w-full text-sm lg:text-base',
