...
export default function Page() {
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-gray-900 to-gray-950">
      ...
      {/* Right side: SignUp Form */}
      <div className="flex w-full flex-col items-center justify-center p-4 lg:p-8 lg:w-1/2">
        <div className="w-full max-w-md space-y-6 lg:space-y-8">
          ...
          {/* SignUp Container */}
          <div className="bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 lg:p-8 border border-purple-500/30 shadow-2xl shadow-purple-500/20">
            <div className="text-center mb-6 lg:mb-8">
              <h2 className="text-xl lg:text-2xl font-bold text-white">Create Account</h2>
              <p className="text-gray-400 mt-2 text-sm lg:text-base">Start mastering interviews today</p>
            </div>
            ...
            <SignUp 
              ...
              appearance={{
                ...
                elements: {
                  ...
                  card: 'bg-transparent shadow-none w-full p-0 m-0 max-w-full',
                  ...
                  socialButtons: 'space-y-3 lg:space-y-4 mb-4 lg:mb-6',
                  socialButtonsBlockButton: 
                    'bg-gray-700 border border-gray-500 text-white hover:bg-gray-600 hover:border-gray-400 transition-all duration-300 rounded-xl py-3.5 px-4 font-medium shadow-lg hover:shadow-xl w-full text-sm lg:text-base',
                  socialButtonsBlockButtonText: 'text-white font-semibold text-sm lg:text-base',
                  socialButtonsProviderIcon: 'filter-none opacity-100 brightness-100 contrast-100 w-5 h-5',
                  
                  // Divider
                  dividerLine: 'bg-gray-600 my-6 lg:my-8',
                  dividerText: 'text-gray-400 text-sm font-medium',
                  
                  // Form fields
                  form: 'space-y-4 lg:space-y-5',
                  formField: 'space-y-2 lg:space-y-3',
                  formFieldLabel: 'text-white text-sm font-medium',
                  formFieldInput: 
                    'bg-gray-700/60 border border-gray-500 text-white placeholder-gray-400 rounded-xl focus:border-purple-500 focus:ring-2 focus:ring-purple-500/30 transition-all duration-300 w-full px-4 py-3 text-sm',
                  
                  // Form actions
                  formButtonPrimary: 
                    'bg-gradient-to-r from-purple-500 to-teal-400 text-white font-semibold rounded-xl shadow-lg shadow-purple-500/30 hover:shadow-xl hover:scale-105 transition-all duration-300 w-full py-3.5 text-sm lg:text-base',
                  formFieldAction: 'text-purple-400 hover:text-purple-300 transition-colors duration-300 text-sm font-medium',
